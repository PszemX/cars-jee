...
public class DtoFunctionFactory {
    ...
    public BrandToResponseFunction brandToResponse() {return new BrandToResponseFunction();}
    public BrandsToResponseFunction brandsToResponse() { return  new BrandsToResponseFunction();}
    public RequestToBrandFunction requestToBrand() { return new RequestToBrandFunction();}

    public CarToResponseFunction carToResponse() {return new CarToResponseFunction();}
    public CarsToResponseFunction carsToResponse() { return  new CarsToResponseFunction();}
    public RequestToCarFunction requestToCar() { return new RequestToCarFunction();}
}
